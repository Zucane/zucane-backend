...
class Empresa(Base):
    ...
    rfc: Mapped[str] = mapped_column(String(20), unique=True, index=True, nullable=False)  # Soporta RFCs de 12-13 caracteres
    ...
    stellar_secret_key: Mapped[str] = mapped_column(String(56), nullable=False)
